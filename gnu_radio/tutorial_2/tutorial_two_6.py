...
# Title: Tutorial Two 6
# Generated: Sat May 20 12:16:24 2017
##################################################
...
class tutorial_two_6(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Tutorial Two 6")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Tutorial Two 6")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "tutorial_two_6")
        self.restoreGeometry(self.settings.value("geometry").toByteArray())

        ##################################################
        # Variables
        ##################################################
        self.variable_qtgui_chooser_0 = variable_qtgui_chooser_0 = 48000
        self.audio_rate = audio_rate = 48000

        ##################################################
        # Blocks
        ##################################################
        self._variable_qtgui_chooser_0_options = (48000, 24000, 160000, )
        self._variable_qtgui_chooser_0_labels = ('48000', '24000', '160000', )
        self._variable_qtgui_chooser_0_tool_bar = Qt.QToolBar(self)
        self._variable_qtgui_chooser_0_tool_bar.addWidget(Qt.QLabel('signal_sampling_rate'+": "))
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(audio_rate, analog.GR_SIN_WAVE, 350, 1, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(audio_rate, analog.GR_SIN_WAVE, 440, 1, 0)
...
def main(top_block_cls=tutorial_two_6, options=None):

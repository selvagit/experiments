...
// Rainbow colors
AlaColor alaPalRainbow_[] = {0xFF0000, 0xAB5500, 0xABAB00, 0x00FF00,
...
AlaColor alaPalRainbowStripe_[] = {0xFF0000, 0x000000, 0xAB5500, 0x000000,
...
AlaColor alaPalParty_[] = {0x5500AB, 0x84007C, 0xB5004B, 0xE5001B,
...
// which looks wrong.
AlaColor alaPalHeat_[] = {0x000000, 0xFF0000, 0xFFFF00, 0xFFFFCC};
AlaPalette alaPalHeat  = {4, alaPalHeat_};

AlaColor alaPalFire_[] = {0x000000, 0x220000, 0x880000,
                          0xFF0000, 0xFF6600, 0xFFCC00};
AlaPalette alaPalFire  = {6, alaPalFire_};

AlaColor alaPalCool_[] = {0x0000FF, 0x0099DD, 0x444488, 0x9900DD};
AlaPalette alaPalCool  = {4, alaPalCool_};

int getStep(long t0, long t, int v) { return ((millis() - t0) % t) * v / t; }
